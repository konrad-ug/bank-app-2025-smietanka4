...
Scenario: User is able to update name of already created account
    ...
    When I update "name" of account with pesel: "89092909246" to "karol"
    Then Account with pesel "89092909246" has "name" equal to "karol"
...
Scenario: Created account has all fields correctly set
    ...
    And Account with pesel "89092909246" has "pesel" equal to "89092909246"

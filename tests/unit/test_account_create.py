...
class TestAccount:
    ...
    def test_loan_approved_three_incoming_transfers(self):
        account = PersonalAccount("John", "Doe",'12345678911')
    ...
    def test_loan_approved_summed_five_transactions(self):
        account = PersonalAccount("John", "Doe",'12345678911')
        account.incoming_transfer(1000)
    ...
    def test_loan_declined_last_three_transactions_werent_incoming_transfers(self):
        account = PersonalAccount("John", "Doe",'12345678911')
        account.incoming_transfer(1000)
        account.outgoing_transfer(500)
        account.incoming_transfer(1000)
    ...
    def test_loan_declined_unsufficient_amount_of_transactions(self):
        account = PersonalAccount("John", "Doe",'12345678911')
        account.incoming_transfer(1000)
        account.incoming_transfer(1000)
        account.incoming_transfer(1000)
    ...
    def test_loan_declined_sufficient_amount_of_transactions_but_sum_is_less_than_loan(self):
        account = PersonalAccount("John", "Doe",'12345678911')
        account.incoming_transfer(1000)
        account.incoming_transfer(1000)
        account.incoming_transfer(1000)
